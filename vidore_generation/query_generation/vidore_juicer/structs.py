...
class Question(BaseModel):
    ...
    question_format: str = Field(description="Format of the question")
...
class Answer(BaseModel):
    page_id: str = Field(description="ID of the page related to the question answer")
    is_answerable: str = Field(
        description=(
            "Whether the question is answerable or not. Can be 'fully answerable', 'partially answerable'"
            " or 'unanswerable'."
        )
    )
    answer: str = Field(description="Answer of the question with respect to the page")


class QRels(BaseModel):
    question: str = Field(description="The question")
    affiliation: Answer = Field(
        description="Page affiliation of the question and its answer."
    )
